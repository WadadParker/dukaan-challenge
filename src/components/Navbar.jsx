...
const Navbar = ({setShowSidebar}) => {
  return (
    <nav className='bg-white flex w-full items-center px-8 py-3 space-x-4 sticky top-0 z-30 max-sm:px-0 max-sm:space-x-2 max-sm:justify-between'>
        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6 shrink-0 sm:hidden" onClick={()=>setShowSidebar(prev=>!prev)}>
